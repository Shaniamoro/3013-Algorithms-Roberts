...
int main(int argc, char **argv)
{
    ...
    G.createSpanningTree("KS", size_of_degree);
    outfile << G.distanceTotal << " miles " << G.edge_count << " edges " << "\n";
   // outfile << G.num_edges << " miles " << G.edge_count << " edges " << "\n";


    outfile << "\n";
    outfile << "Miami Beach, Florida" << "\n";
    G.createSpanningTree("FL", size_of_degree);
    outfile << G.distanceTotal << " miles " << G.edge_count << " edges " << "\n";

    outfile << "\n";
    outfile << "Lake Dallas, Texas" << endl;
    G.createSpanningTree("TX", size_of_degree);
    outfile << G.distanceTotal << " miles " << G.edge_count << " edges " << "\n";

    outfile << "\n";
    outfile << "Boston, Massachusetts" << endl;
    G.createSpanningTree("MA", size_of_degree);
    outfile << G.distanceTotal << " miles " << G.edge_count << " edges " << "\n";
